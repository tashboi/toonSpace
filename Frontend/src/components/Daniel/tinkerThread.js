...
class TinkerThread extends React.Component{
    constructor(props) {
        super(props)
        this.state = {
        userID: null,
    ...
    handleSubmitClick = () => {
        let url = "http://unn-w18018515.newnumyspace.co.uk/26test/new/api/threadit" 
    ...
    confirmDelete=()=>{
        let url = "http://unn-w18018515.newnumyspace.co.uk/26test/new/api/threadelete" 
